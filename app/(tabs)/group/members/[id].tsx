...
import { getGroup, getMembers} from "@/services/groupServices";
import { Tables } from "@/types/database.types";
import { MemberRelationship } from "@/types/extended-types";
            ...
            <VStack space="md">
              {
                ...
                //   members?.map((groupRel) => (
                //   <MemberCard key={groupRel.id} groupRel={groupRel}/>
                //   <Text key={groupRel.profile.name}></Text>
                // )
                ) : <Spinner/>
              }
            </VStack>
