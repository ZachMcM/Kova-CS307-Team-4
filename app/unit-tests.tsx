  ...
  const tests = [
      ...
      params: [
        {
          ...
          testCaseName: "Non-existent email",
          testEmail: "doesnotexist@doesnotexist.com",
          testPassword: "Aaa123",
        ...
        },
        {
          ...
          testPassword: "Aaa123456789",
          expectedError: "Invalid login credentials",
        },
        {
          signInUser: signInUser,
          testCaseName: "Email regex",
          testEmail: "' = X OR 'Y' = 'Y'",
          testPassword: "Aaa123456789",
        ...
        {
          signInUser: signInUser,
          testCaseName: "Password Empty",
          testEmail: "testuser@testuser.com",
          testPassword: "",
          expectedError: "Password field cannot be empty",
        },
        {
          signInUser: signInUser,
      ...
      params: [
        {
          ...
          testCaseName: "Invalid email regex",
          addRandom: true,
          testEmail: "notvalidemail.com",
          testPassword: "Aaa123",
          testConfirmPassword: "Aaa123",
          testUsername: "unittester",
          testDisplayName: "unitTest Display Name",
          expectedError: "Please enter a valid email address",
        },
        {
          createAccount: createAccount,
          testCaseName: "Non-matching passwords",
          addRandom: true,
          testEmail: "unittester@test.com",
          testPassword: "Aaa1234",
          testConfirmPassword: "Aaa123",
          testUsername: "unittester",
          testDisplayName: "unitTest Display Name",
          expectedError: "Password and confirmed password\nmust match",
        },
        {
          createAccount: createAccount,
          testCaseName: "Blank username",
          addRandom: false,
          testEmail: "unittester@test.com",
          testPassword: "Aaa123",
          testConfirmPassword: "Aaa123",
        ...
        {
          createAccount: createAccount,
          testCaseName: "Username with spaces",
          addRandom: true,
          testEmail: "unittester@test.com",
          testPassword: "Aaa123",
          testConfirmPassword: "Aaa123",
          testUsername: "unit tester",
          testDisplayName: "unitTest Display Name",
          expectedError: "Username cannot include spaces",
        },
        {
          createAccount: createAccount,
          testCaseName: "Username already in use",
          addRandom: false,
          testEmail: "unittester@test.com",
          testPassword: "Aaa123",
          testConfirmPassword: "Aaa123",
        ...
        {
          createAccount: createAccount,
          testCaseName: "Email already in use",
          addRandom: false,
          testEmail: "testuser@testuser.com",
          testPassword: "Aaa123",
          testConfirmPassword: "Aaa123",
        ...
        {
          createAccount: createAccount,
          testCaseName: "Password min requirements length",
          addRandom: true,
          testEmail: "unittester@test.com",
          testPassword: "Aaa12",
          testConfirmPassword: "Aaa12",
          testUsername: "unittester",
          testDisplayName: "unitTest Display Name",
          expectedError:
        ...
        {
          createAccount: createAccount,
          testCaseName: "Password min requirements letter",
          addRandom: true,
          testEmail: "unittester@test.com",
          testPassword: "123456",
          testConfirmPassword: "123456",
          testUsername: "unittester",
          testDisplayName: "unitTest Display Name",
          expectedError:
            "Password must be at least 6 characters\n and include a letter and number",
        ...
        {
          createAccount: createAccount,
          testCaseName: "Password min requirements number",
          addRandom: true,
          testEmail: "unittester@test.com",
          testPassword: "abcdef",
          testConfirmPassword: "abcdef",
          testUsername: "unittester",
          testDisplayName: "unitTest Display Name",
          expectedError:
            "Password must be at least 6 characters\n and include a letter and number",
        ...
        {
          createAccount: createAccount,
          testCaseName: "Successful registration",
          addRandom: true,
          testEmail: "unittester@test.com",
          testPassword: "Aaa123",
          testConfirmPassword: "Aaa123",
    ...
    },
    {
      ...
      params: [
        {
          signInUser,
          correctPassword: "aaa123",
          updatePassword,
          testCaseName: "Non-matching passwords",
          testEmail: "passwordtester@test.com",
          testOldPassword: "aaa123",
          testNewPassword: "aaa123",
          testVerifyPassword: "aaa1234",
          expectedError: "Password and confirmed password\nmust match",
        },
        {
          signInUser,
          correctPassword: "aaa123",
          updatePassword,
          testCaseName: "Old password incorrect",
          testEmail: "passwordtester@test.com",
          testOldPassword: "aaa1234124",
          testNewPassword: "aaa1234",
          testVerifyPassword: "aaa1234",
        ...
        },
        {
          ...
          correctPassword: "aaa123",
          updatePassword,
          testCaseName: "Same new and old password",
          testEmail: "passwordtester@test.com",
          testOldPassword: "aaa123",
          testNewPassword: "aaa123",
          testVerifyPassword: "aaa123",
          expectedError:
        ...
        },
        {
          ...
          testEmail: "passwordtester@test.com",
          testOldPassword: "aaa123",
          testNewPassword: "aaa1",
          testVerifyPassword: "aaa1",
          expectedError:
        ...
        },
        {
          ...
          correctPassword: "aaa123",
          updatePassword,
          testCaseName: "Successful password reset",
          testEmail: "passwordtester@test.com",
          testOldPassword: "aaa123",
          testNewPassword: "aaa123456A",
          testVerifyPassword: "aaa123456A",
          expectedError: null,
        },
                ...
                {testPending ? (
                  ...
                  <Box>
                    <Text size="lg" className="ml-1">
                      Tests Successful: {correctTests}/{test.totalTests}
                    </Text>
                    <Text size="lg" className="ml-1">
                      Output
                    </Text>
